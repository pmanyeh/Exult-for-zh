...
labelFunc0401_0173:
	...
	message(var0000);
	message("，距離我們上次見面已經過了兩百個不列顛年了？為什麼你一點都沒老！\"");
	say();
	message("Iolo 神秘兮兮地眨了眨眼。他低聲說：\"這無疑是因為我們故鄉和不列顛尼亞 (Britannia) 的時間結構不同吧？\"~~他恢復了正常的音量。\"如你所見，我確實老了一些。但這也是理所當然的，我這段時間一直留在不列顛尼亞。~~\"喔，不過聖者！等我告訴其他人！他們見到你一定會非常高興！歡迎來到 Trinsic！\"*");
	say();
...
labelFunc0401_040E:
	UI_remove_answer("謀殺");
labelFunc0401_0415:
	case "不列顛之王" attend labelFunc0401_0452:
	var000A = true;
	if (!gflags[0x0065]) goto labelFunc0401_0432;
	message("\"嗯，我們私底下說說，我覺得他看起來比我老多了！\"");
	say();
	message("\"那傢伙知道很多情報。但他似乎再也不離開不列顛 (Britain) 了。\"");
	say();
	goto labelFunc0401_0436;
labelFunc0401_0432:
	message("\"陛下見到你一定會非常高興。我們應該火速前往不列顛 (Britain)。我肯定他能為你提供一些有價值的情報，並告訴你這消失的兩百年來發生了什麼事。\"");
	say();
labelFunc0401_0436:
...
labelFunc0401_06FA:
	...
	message("\"我對他們了解不多，只知道他們大約起源於二十個不列顛年前。他們似乎在做善事，也受到大多數人的青睞。他們在整個不列顛尼亞都有分會。不過我個人沒有和他們打過交道。\"");
	say();
	UI_remove_answer("友誼會");
labelFunc0401_070D:
	case "佩特" attend labelFunc0401_0720:
	message("\"他只是個泛泛之交。\"");
	say();
	UI_remove_answer("佩特");
labelFunc0401_0720:
	case "結束" attend labelFunc0401_072B:
