...
labelFunc040C_011F:
	...
	message("\"伊奧洛 (Iolo)！這個陌生人是誰？\"*");
	say();
	UI_show_npc_face(0xFFFF, 0x0000);
	message("\"哎呀，這位是聖者！\" 伊奧洛自豪地宣布。\"你敢相信嗎？請容我為你介紹？這位是特林西克 (Trinsic) 的鎮長 Finnigan。而這位是 ");
	message(var0001);
	message("，聖者！");
	say();
...
labelFunc040C_0179:
	UI_show_npc_face(0xFFF4, 0x0000);
	message("鎮長上下打量著你，不確定是否該相信伊奧洛。他用懷疑的眼神看著伊奧洛。");
	say();
	UI_show_npc_face(0xFFFF, 0x0000);
...
labelFunc040C_01AD:
	...
	message("\"佩特知道一些關於這件事的事情。\"*");
	say();
	UI_show_npc_face(0xFFF5, 0x0000);
	message("那名農夫插嘴道。\"我今天清晨發現了可憐的克里斯多福和石像鬼伊納莫。\"*");
	say();
	UI_remove_npc_face(0xFFF5);
	goto labelFunc040C_0202;
labelFunc040C_01F4:
	UI_show_npc_face(0xFFF4, 0x0000);
	message("\"馬廄管理員佩特，在今天清晨發現了可憐的克里斯多福和伊納莫。\"");
	say();
labelFunc040C_0202:
	UI_show_npc_face(0xFFF4, 0x0000);
...
labelFunc040C_0293:
	...
	message("\"我是特林西克的鎮長，自從我三年前來到這裡就一直是。\"");
	say();
	UI_add_answer("特林西克");
labelFunc040C_02A6:
	case "特林西克" attend labelFunc040C_02DF:
...
labelFunc040C_02C3:
	message("\"特林西克曾經是榮譽之城。我想現在依然是。我們的榮譽符文很多年前 ");
	message(var0008);
	message("我相信它現在被保存在不列顛城 (Britain) 的皇家博物館中，然而城鎮中心仍留著空蕩蕩的基座。我覺得這象徵著這個城鎮本身。它是相當空虛的——沒有人氣，沒有生氣，也沒有榮譽。真的很悲哀。\"");
	say();
	message("\"然後當然還有這起謀殺案。我們暫時關閉了城門，需要密碼才能進出。\"");
	say();
	UI_remove_answer("特林西克");
	UI_add_answer("密碼");
labelFunc040C_02DF:
...
labelFunc040C_032C:
	...
	message("\"特林西克以前從未發生過這樣的犯罪。我不敢相信這種事會發生在克里斯多福和伊納莫身上。拜託——去城鎮裡調查吧！如果你能向我報告你的進展，我會非常感激。務必向鎮上的每個人詢問關於謀殺案的事。在和克里斯多福的兒子談過之後，你可能接著會想去和吉爾伯托 (Gilberto) 談談，他是昨晚在碼頭值班的守衛。\"");
	say();
	message("鎮長猶豫了一下，然後湊近小聲說道。");
	say();
	message("\"事實上，我以前見過類似的情況。大約是四年前，在不列顛城。\"");
	say();
	UI_add_answer(["吉爾伯托", "克里斯多福", "伊納莫", "不列顛城", "報告"]);
	gflags[0x005B] = true;
	UI_remove_answer("謀殺");
...
labelFunc040C_036F:
	...
	message("\"那是在我來到特林西克之前的事了。曾經發生過一起有著驚人相似之處的謀殺案。發現了一具被肢解的屍體，就像可憐的克里斯多福一樣。那看起來像是一場儀式性的殺戮。我敢打賭，當年那起謀殺案的凶手就是這次事件的幕後黑手。\"");
	say();
	UI_remove_answer("不列顛城");
labelFunc040C_0382:
	case "兒子" attend labelFunc040C_0395:
	message("\"克里斯多福的兒子名叫斯帕克。他們的房子在城鎮的西北區。\"");
	say();
	UI_remove_answer("兒子");
labelFunc040C_0395:
	case "吉爾伯托" attend labelFunc040C_03B5:
	message("\"他今天清晨從背後遭到襲擊，被打得失去了知覺。早班守衛強森 (Johnson) 發現他不省人事。他目前正在鎮上西側治療師江圖 (Chantu) 的房子裡休養。\"");
	say();
	UI_remove_answer("吉爾伯托");
	UI_add_answer(["強森", "江圖"]);
labelFunc040C_03B5:
	case "江圖" attend labelFunc040C_03C8:
...
labelFunc040C_0439:
	case "克羅格" attend labelFunc040C_044C:
	message("\"他是友誼會的分會長。是個善良的人。\"");
	say();
	UI_remove_answer("克羅格");
labelFunc040C_044C:
	case "強森" attend labelFunc040C_045F:
	message("\"他現在可能在碼頭。\"");
	say();
	UI_remove_answer("強森");
labelFunc040C_045F:
	case "克里斯多福" attend labelFunc040C_0479:
	message("\"克里斯多福是當地的鐵匠。他和他兒子住在一起，或者該說『曾經』住在一起，在城鎮西北部。鐵匠鋪在西南角。克里斯多福絕對不是個有錢人——他勉強能養活自己和兒子。但他肯定很享受他的工作。\"");
	say();
	UI_remove_answer("克里斯多福");
	UI_add_answer("兒子");
labelFunc040C_0479:
	case "伊納莫" attend labelFunc040C_048C:
	message("\"據我所知，石像鬼伊納莫睡在馬廄裡。我相信他幾個月前才從泰爾芬 (Terfin) 移居到這裡。看來他只是一個遭到暴力襲擊的無辜受害者。\"");
	say();
	UI_remove_answer("伊納莫");
labelFunc040C_048C:
	case "密碼" attend labelFunc040C_04EB:
	...
	say();
	message("\"喔——我差點忘了！離開或進入城鎮的密碼是『黑鳥 (Blackbird)』！\"*");
	say();
	gflags[0x003D] = true;
	Func0911(0x0064);
	abort;
...
labelFunc040C_04C5:
	message("\"嗯。恐怕我還是對你是否為聖者感到懷疑。我的公職不允許我把密碼給你。我很抱歉。\"");
	say();
	abort;
labelFunc040C_04CA:
...
labelFunc040C_04E4:
	UI_remove_answer("密碼");
labelFunc040C_04EB:
	case "結束" attend labelFunc040C_04F6:
