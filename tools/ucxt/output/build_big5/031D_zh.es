...
labelFunc031D_0270:
	...
	message("《水下拾荒與板球運動法案》 ~~ 23568976.Y7，第 069 節 ~~ 據此，隸屬於第一隊之第一方參與者，亦得於距離碼頭二百三十九英尺之範圍內，進行額外之尋寶活動。 ~~ 據此，隸屬於第二隊之第二方參與者亦得依循辦理；惟其不得於距離第一部分之第一方（甲方）七英尺半的範圍內使用任何手帕。 ~~ 特此聲明，第一部分之第二方不得牽涉外部...");
	say();
	goto labelFunc031D_0487;
labelFunc031D_0281:
...
labelFunc031D_02C5:
	...
	message("《室內動物飼養法案》 ~~ 89634510.P4，第 402 節 ~~");
	say();
	message(" 據此，隸屬於所有者一方之參與者，獲准將動物及其相關照護物資存放於室內，前提是...");
	say();
	goto labelFunc031D_0487;
labelFunc031D_02DA:
