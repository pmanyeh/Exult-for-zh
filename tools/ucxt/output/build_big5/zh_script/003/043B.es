...
void Func043B object#(0x43B) ()
{
	...
	message("Sean 全神貫注地聽著兄弟會的集會。*");
	say();
	abort;
	goto labelFunc043B_0074;
labelFunc043B_005F:
	if (!gflags[0x00DA]) goto labelFunc043B_006F;
	message("「我無法想像 Batlin 在哪裡。他從不錯過兄弟會集會！」");
	say();
	goto labelFunc043B_0074;
	goto labelFunc043B_0074;
labelFunc043B_006F:
	message("「我現在不能停下來說話！我參加兄弟會集會要遲到了！」*");
	say();
	abort;
labelFunc043B_0074:
...
labelFunc043B_00B6:
	...
	message("「當我不在處理兄弟會事務時，我是 Britain 這裡的珠寶商。如果你想買些什麼，請說！」");
	say();
	UI_add_answer(["兄弟會", "珠寶商", "Britain", "買東西"]);
labelFunc043B_00D5:
...
labelFunc043B_0250:
	UI_remove_answer("寶石");
labelFunc043B_0257:
	case "兄弟會" attend labelFunc043B_0285:
	if (!var0003) goto labelFunc043B_026C;
	message("「我看你也是成員！」 Sean 突然用較為尊敬的眼神看著你。「我相信兄弟會未來會為你帶來無窮的好處。」他帶著高傲的笑容說道。");
	say();
	goto labelFunc043B_0277;
labelFunc043B_026C:
	message("「甚至連你也可以加入兄弟會，我可以告訴你更多關於它的事。」");
	say();
	Func0919();
	message("「如果你想聽，我可以告訴你兄弟會的哲學。」");
	say();
labelFunc043B_0277:
	UI_remove_answer("兄弟會");
	UI_add_answer("哲學");
labelFunc043B_0285:
	case "哲學" attend labelFunc043B_02AE:
	message("「你真的有興趣聽更多嗎？」");
	say();
	var0010 = Func090A();
...
labelFunc043B_02AE:
	...
	message("「我把整個生意搬到 Britain ，就是為了靠近兄弟會的總部。你根本無法想像我加入兄弟會之後，我的生意改善了多少。」");
	say();
