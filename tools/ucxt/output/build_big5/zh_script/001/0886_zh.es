...
labelFunc0886_0253:
	...
	message("「在我給你密碼之前，我必須承認，我一直對你是否真的是聖者抱有懷疑。為了解除我天生的疑心病，我必須請你配合一下。我將問你幾個關於 Britannia 地理的問題。請根據你布地圖上的經度或緯度數字來回答。記住——經度是指南北走向的線，它們由地圖底部的數字決定。緯度是指東西走向的線，它們由地圖左側的數字決定。如果這些問題你都回答正確，那麼我將拋開我所有的疑慮。」");
	say();
	enum();
labelFunc0886_0294:
