...
labelFunc040E_0009:
	...
	message("「兄弟會的會議結束後，我會和你談談。」");
	say();
	goto labelFunc040E_0041;
labelFunc040E_003D:
	message("「我得趕去參加兄弟會的會議！我遲到了！我們明天再談，好嗎？」");
	say();
labelFunc040E_0041:
	abort;
labelFunc040E_0042:
...
labelFunc040E_00A5:
	...
	UI_remove_answer("姓名");
labelFunc040E_00BB:
	case "工作" attend labelFunc040E_00CE:
...
labelFunc040E_00F4:
	case "兄弟會" attend labelFunc040E_011E:
...
labelFunc040E_0131:
	...
	message("「如果你想要一艘船，你必須從船匠那裡拿到一張船契。你還必須有離開城鎮的密碼。」");
	say();
	UI_add_answer(["暗語", "船契"]);
	UI_remove_answer("船隻");
labelFunc040E_0151:
	case "暗語" attend labelFunc040E_01B2:
	message("「暗語是什麼？」");
	say();
...
labelFunc040E_017C:
	...
	if (!(var0002 == "黑鳥")) goto labelFunc040E_01AA;
	var0004 = Func0834();
...
labelFunc040E_01AA:
	message("「你不知道暗語。很抱歉。鎮長可以給你正確的暗語。」");
	say();
	gflags[0x0042] = true;
labelFunc040E_01B2:
