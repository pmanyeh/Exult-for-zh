...
void Func089E 0x89E (var var0000, var var0001, var var0002)
{
	...
	message("¡u§Ú¯à´£¨ÑªvÀø¡B¸Ñ¬r©M´_¬¡ªºªA°È¡C§A¹ï¨ä¤¤¤@¶µªA°È·P¿³½ì¶Ü¡H¡v");
	say();
	UI_push_answers();
	var0005 = Func090A();
	if (!var0005) goto labelFunc089E_0295;
	message("¡u§A»Ý­n§Úªº­þ¶µªA°È¡H¡v");
	say();
	var0006 = ["ªvÀø", "¸Ñ¬r", "´_¬¡"];
	var0007 = Func090B(var0006);
	if (!((var0007 == "ªvÀø") || (var0007 == "¸Ñ¬r"))) goto labelFunc089E_012E;
	if (!(var0007 == "ªvÀø")) goto labelFunc089E_0069;
	var0008 = "ªvÀø";
	var0009 = var0000;
labelFunc089E_0069:
	if (!(var0007 == "¸Ñ¬r")) goto labelFunc089E_007F;
	var0008 = "¸Ñ¬r";
	var0009 = var0001;
labelFunc089E_007F:
	message("¡u§A·QÅý½Ö±µ¨ü");
	message(var0008);
	message("¡H¡v");
	say();
...
labelFunc089E_011D:
	...
	message("¡u¸tªÌ¡I§A¥s§Ú·Ç³ÆªvÀø¡AµM«á¤S¸ò§Ú»¡¡y¨S¦³¤H¡z¡I§AÄ±±o³o«Ü¦n¯º¶Ü¡HªvÀø¥i¬O¤@¥óÄYµÂªº¨Æ¡I¡v");
	say();
	goto labelFunc089E_0299;
labelFunc089E_012E:
	if (!(var0007 == "´_¬¡")) goto labelFunc089E_019B;
	...
	if (!(var0016 == 0x0000)) goto labelFunc089E_0178;
	message("¡u§Ú¤@©w¬O²´ªá¤F¡C§Ú¨S¬Ý¨ì¦³¥ô¦ó¤H»Ý­n´_¬¡¡C§A¤S¦b­A§Ú¤F¶Ü¡HÁÙ¬O§A§â¶ËªÌÂÃ°_¨Ó¤F¡H§Ú¥²¶·¬Ý¨ì¤H¤~¯à´£¨ÑÀ°§U¡C¦pªG§A§âªB¤Í­I¦b­I¥]¸Ì¡A«ô°U§â¥L©ñ¦b¦a¤W¡A³o¼Ë§Ú¤~¯à¼i¦æ§A­n¨DªºÂ¾³d¡C¡v");
	say();
	abort;
labelFunc089E_0178:
	message("¡u½T¹ê¡A§AªºªB¤Í¶Ë±o«Ü­«¡CÅý¥X¤@ÂIªÅ¶¡¡A§Ú·|ºÉ§Ú©Ò¯àªvÀø¥L¡C¡v");
	say();
...
labelFunc089E_019B:
	...
	message("¡u¬JµM§Ú©M§A­Ì¤@°_®È¦æ¡A§Ú´N§K¦¬¶O¥Î¤F¡C¡v");
	say();
	if (!(var0007 == "ªvÀø")) goto labelFunc089E_01CA;
	Func091D(var0014, var0009);
	gflags[0x0029] = true;
	UI_set_timer(0x000A);
	goto labelFunc089E_0292;
labelFunc089E_01CA:
	if (!(var0007 == "¸Ñ¬r")) goto labelFunc089E_01EB;
	Func091E(var0014, var0009);
	gflags[0x0029] = true;
	UI_set_timer(0x000A);
	goto labelFunc089E_0292;
labelFunc089E_01EB:
	if (!(var0007 == "´_¬¡")) goto labelFunc089E_020C;
...
labelFunc089E_020F:
	message("¡u§Úªº¦¬¶O¬O ");
	message(var0009);
	message(" ªTª÷¹ô¡C³o­Ó»ù®æ§A¥i¥H±µ¨ü¶Ü¡H¡v");
	say();
	var0005 = Func090A();
	...
	if (!(var0007 == "ªvÀø")) goto labelFunc089E_0258;
	Func091D(var0014, var0009);
	goto labelFunc089E_0292;
labelFunc089E_0258:
	if (!(var0007 == "¸Ñ¬r")) goto labelFunc089E_026E;
	Func091E(var0014, var0009);
	goto labelFunc089E_0292;
labelFunc089E_026E:
	if (!(var0007 == "´_¬¡")) goto labelFunc089E_0284;
	Func091F(var0016, var0009);
	goto labelFunc089E_0292;
labelFunc089E_0284:
	goto labelFunc089E_028B;
labelFunc089E_0287:
	message("¡u§A¨S¦³¨º»ò¦hª÷¹ô¡I¤]³§A¥i¥H±a§ó¦hªº¿ú¦^¨Ó¦AÁÊ¶RªA°È¡C¡v");
	say();
labelFunc089E_028B:
	goto labelFunc089E_0292;
labelFunc089E_028E:
	message("¡u¨º§A¥u¯à¥h§O³B´M§ä³oºØªA°È¤F¡C¡v");
	say();
labelFunc089E_0292:
	goto labelFunc089E_0299;
labelFunc089E_0295:
	message("¡u¦pªG§A¥H«á»Ý­n§ÚªºªA°È¡A§Ú·|¦b³o¸Ì¡C¡v");
	say();
labelFunc089E_0299:
	UI_pop_answers();
	return;
