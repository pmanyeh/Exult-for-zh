...
labelFunc04B1_0196:
	message("「『很抱歉，聖者。』她悲傷地搖搖頭。『你沒有金幣來品嚐它們。』~~她盯著你看了一會兒，顯然在思考。她壓低聲音說：~~『拿去吧，聖者，拿一個。』」");
	say();
...
labelFunc04B1_021C:
	...
	message("「在 Paws 這裡生活很艱苦。這是一個窮人的城鎮，伴隨著貧窮帶來的所有弊病。至少兄弟會給我們帶來了一些慰藉。」");
	say();
	UI_add_answer(["弊病", "兄弟會"]);
...
labelFunc04B1_0259:
	case "兄弟會" attend labelFunc04B1_026C:
	message("「我不確定我是否信任兄弟會。它無疑在這個世界上做了一些好事，所以它不可能全是壞的。或者，至少，裡面的人不可能全是壞的。」");
	say();
...
labelFunc04B1_02AB:
	...
	message("「Feridwyn 那個男人知道我不信任兄弟會，因此他把我視為他的個人敵人。我不知道他為什麼試圖透過我兒子來攻擊我，但他絕不能得逞。」");
	say();
