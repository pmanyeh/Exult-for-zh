...
labelFunc04A8_009B:
	...
	message("「我幫我丈夫 Feridwyn 經營兄弟會在 Paws 的庇護所。」");
	say();
	UI_add_answer(["Feridwyn", "兄弟會", "庇護所", "Paws"]);
labelFunc04A8_00BA:
	case "Feridwyn" attend labelFunc04A8_0109:
	if (!(!gflags[0x0220])) goto labelFunc04A8_00D0;
	message("「我丈夫是個好人，他無私地奉獻自己來幫助鎮上的窮人，而他們卻毫不感激。他是個好人，也是個盡責的兄弟會成員。」");
	say();
...
labelFunc04A8_0109:
	case "兄弟會" attend labelFunc04A8_012A:
	if (!(!gflags[0x0006])) goto labelFunc04A8_011F;
	message("「你應該跟我丈夫談談兄弟會的事。我敢肯定你對他要告訴你的事會印象深刻的。」");
	say();
	goto labelFunc04A8_0123;
labelFunc04A8_011F:
	message("「看到你加入了兄弟會，只是證實了我早已知道的事。那就是兄弟會是我們帶領 Britannia 邁向美好新未來的道路。你加入我們的消息正在四處傳開！」");
	say();
labelFunc04A8_0123:
...
labelFunc04A8_0177:
	...
	message("「Alina 和她的孩子住在庇護所裡，可憐的東西。她的丈夫是個普通的小偷，現在還在監獄裡。但一旦我們說服她加入兄弟會，我們就會幫助她把生活整頓好。你知道的，她不夠聰明，看不出這對她有什麼好處。必須仔細指導她。」");
	say();
	UI_remove_answer("Alina");
labelFunc04A8_018A:
	case "Camille" attend labelFunc04A8_01AA:
	message("「Camille 是一個農場寡婦。她傾向於活在過去，遵循舊有的美德並質疑兄弟會的做法。你知道的，這些鄉下人很迷信。這是他們智力低下造成的。她甚至沒有注意到她的兒子 Tobias 長大後變成了什麼樣的流氓！完全不像我們的兒子 Garritt。」");
	say();
...
labelFunc04A8_01E6:
	...
	message("「Brita 喜笑顏開。『Garritt 是一個很棒的兒子。他正在被撫養長大以遵循兄弟會的價值觀。他的價值得到了回報。』」");
	say();
	UI_add_answer("回報");
...
labelFunc04A8_0221:
	...
	message("「Polly 經營當地酒館是為了靠近人群。她是一個孤獨的靈魂，覺得根本沒有人渴望她的心。想到她就讓我好難過。如果她加入兄弟會，她就能找到所有她想要的陪伴。」");
	say();
