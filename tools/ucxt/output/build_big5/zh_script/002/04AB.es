...
labelFunc04AB_009D:
	...
	message("「我還太小，無法學習自己的手藝，但我確實協助我的父母經營庇護所。我希望有一天能成為兄弟會的顧問。或者是專業的排笛手。」");
	say();
	UI_add_answer(["庇護所", "兄弟會", "排笛"]);
labelFunc04AB_00B9:
	case "Feridwyn" attend labelFunc04AB_00DC:
	message("「我父親為兄弟會工作，幫助 Paws 這裡的窮人。他試圖招募他們，但大多數人都拒絕了。」");
	say();
...
labelFunc04AB_0137:
	...
	message("「他和他的母親拒絕兄弟會。他們既無知又愚蠢，我不喜歡他們。」");
	say();
	goto labelFunc04AB_0149;
labelFunc04AB_0145:
...
labelFunc04AB_0150:
	...
	message("「我父親曾經是 Britain 的首席招募員，直到他們把他調來這裡。我曾聽他對母親說，兄弟會在這裡是浪費時間。」");
	say();
	UI_remove_answer("招募");
labelFunc04AB_0163:
	case "窮人" attend labelFunc04AB_017D:
	message("「我父親說窮人拒絕兄弟會，是因為內在力量的三位一體需要堅強的品格。」");
	say();
	UI_remove_answer("窮人");
	UI_add_answer("品格");
labelFunc04AB_017D:
...
labelFunc04AB_019C:
	...
	message("「哼。作為一個兄弟會成員，你缺乏認知。你不了解兄弟會的教義。」");
	say();
	goto labelFunc04AB_01AD;
labelFunc04AB_01A9:
...
labelFunc04AB_01DA:
	case "兄弟會" attend labelFunc04AB_0204:
...
labelFunc04AB_0204:
	case "哲學" attend labelFunc04AB_0232:
	message("「談到我們的哲學，我也相當了解。我們遵循內在力量的三位一體，不讓個人的失敗阻礙我們或拖累我們。」");
	say();
	message("「你想加入嗎？」");
	say();
	var0004 = Func090A();
...
labelFunc04AB_02AD:
	...
	message("「我認為如果 Tobias 被指控偷了大家都會注意到的東西，他的母親就會加入兄弟會並強迫他也加入。這將改善他們的生活，並迫使他們看清自己的真相。」");
	say();
	UI_remove_answer("擔心");
labelFunc04AB_02C0:
	...
	message("「但我，像你一樣，是兄弟會的成員。對於我試圖做的事，你必須與我團結一致！」");
	say();
	UI_remove_answer("父母");
