...
out_file = r'd:\git\exult-master\tools\ucxt\output\py_scripts\batch_12_strings.txt'

files_to_extract = [f'04{hex(i)[2:].upper()}' for i in range(0xD2, 0xDB+1)]
...
print(f'Extracted {len(all_strings)} strings for Batch 12.')
