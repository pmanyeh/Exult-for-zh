...
out_file = r'd:\git\exult-master\tools\ucxt\output\py_scripts\batch_14_strings.txt'

files_to_extract = [f'04{hex(i)[2:].upper()}' for i in range(0xE6, 0xEF+1)]
...
print(f'Extracted {len(all_strings)} strings for Batch 14.')
