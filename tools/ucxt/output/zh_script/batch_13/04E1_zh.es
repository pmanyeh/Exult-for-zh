...
labelFunc04E1_0089:
	...
	message("「我是遊戲之屋 (House of Games) 的守衛。我替這地方清除麻煩製造者。」");
	say();
	UI_add_answer(["遊戲之屋 (House of Games)", "麻煩製造者"]);
labelFunc04E1_00A2:
	case "遊戲之屋 (House of Games)" attend labelFunc04E1_00BC:
	message("「自從老闆 (The Mister) 同意付我錢並要我留下後，我就一直在遊戲之屋 (House of Games) 工作。我知道所有進出的人。我看到了一切。」");
	say();
	UI_remove_answer("遊戲之屋 (House of Games)");
	UI_add_answer("老闆 (The Mister)");
labelFunc04E1_00BC:
	case "老闆 (The Mister)" attend labelFunc04E1_00CF:
	message("「那會是 Gordy 先生，遊戲之屋 (House of Games) 的監督。你或許可以在營業時間去他的辦公室找他。」");
	say();
...
labelFunc04E1_0166:
	...
	message("當 Sintag 說話時方塊震動了。「Hook 住在遊戲之屋 (House of Games) 後面的洞穴裡。遊戲室有一扇上鎖的門通向那裡。我有鑰匙。 Gordy 的辦公室裡也有一扇暗門，那是 Hook 用來回家的。」");
	say();
	UI_add_answer("鑰匙");
...
labelFunc04E1_0193:
	message("「我現在看起來像在工作嗎？別煩我。在正常營業時間來遊戲之屋 (House of Games) 吧。」");
	say();
labelFunc04E1_0197:
