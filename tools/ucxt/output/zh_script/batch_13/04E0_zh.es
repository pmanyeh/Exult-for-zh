...
labelFunc04E0_025C:
	...
	message("Roberto 笑了。「沒關係。我們來聊點什麼？冒險？秘密通道和地城？」~~ Roberto 靠近並低聲說：「你知道有秘密通道連接 Buccaneer's Den 的建築物嗎？這是真的！我相當確定入口是透過遊戲之屋 (House of Games) ，我也很確定有一條路可以進入澡堂。」~~你和 Roberto 聊了許多其他話題，直到你意識到你在溫泉裡待了太久。還有任務要完成！");
	say();
	UI_remove_answer("聊天");
labelFunc04E0_026F:
