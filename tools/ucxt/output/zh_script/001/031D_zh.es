...
labelFunc031D_0343:
	...
	var0001 = Func0908();
	message("最親愛的 Iolo，~     在 Buccaneer's Den，我遇到了一位老海盜，他告訴我，他航行過 Britannia 海域的次數比我經歷過的夏天還要多。出於賭博的心態，我問他是否聽說過傳說中的巨蛇島 (Serpent Isle)。他聽過！而且他甚至還有一張標示著如何找到該島嶼的地圖。我買下了地圖，並已經開始了我的尋找之旅。不過，我留了一份副本，好讓你在完成目前的冒險後可以跟上我。我已將副本交給 Lord British，但他答應我，直到你與 ");
	message(var0001);
