...
labelFunc0282_006F:
	...
	say();
	message("雖然友誼會預示著自己是一個樂觀主義者的團體，其哲學被稱為『內在力量的三位一體 (Triad of Inner Strength)』，但仔細審視該團體的『價值觀』，可以發現許多謬誤。");
	say();
...
labelFunc0282_0123:
	...
	say();
	message("     目前尚不清楚 Hook 居住在哪裡，但許多人認為他在 Buccaneer's Den 有一個秘密藏身處。他最近一次被目擊證實，他正與一名名叫 Forskis 的戰士石像鬼同行。~~");
	say();
...
labelFunc0282_03C3:
	...
	message("~~ ~~《魔法與馬車保養的藝術》*");
	say();
	message("     這本厚重的書卷包含了關於生活各個方面的奇妙智慧明珠。文字讚揚了基本、尋常的快樂的價值，並譴責了物質財富與幸福的相關性。這種哲學簡單到足以被輕易掌握，但又足夠完整，非常全面。~");
	say();
