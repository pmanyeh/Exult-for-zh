...
labelFunc040B_008F:
	message("Petre 看起來很困惑。「你不該拿我尋開心！」他轉過身去。*");
	say();
	gflags[0x004B] = true;
	abort;
labelFunc040B_0098:
...
labelFunc040B_0120:
	message("「在你離開 Trinsic 整整一天後，市長才讓我去那裡打掃。他認為我們必須保持犯罪現場的完整。嗯，如果你問我，我可以告訴你，那裡面還是臭得像世界末日一樣！」");
	say();
labelFunc040B_0124:
	UI_remove_answer("馬廄");
	UI_add_answer("馬車");
labelFunc040B_0132:
	...
	message("「我今天早上發現了可憐的 Christopher 和 Inamo。我什麼都沒碰。這讓我覺得噁心，真的！」");
	say();
	UI_remove_answer("謀殺");
...
labelFunc040B_0178:
	...
	message("「馬和馬車的組合賣 60 枚金幣。你想要所有權狀嗎？」");
	say();
	var0005 = Func090A();
...
labelFunc040B_024E:
	message("Petre 揉了揉男孩的頭髮。~~「這個是 Christopher 的兒子。Spark 是個好孩子，只要他不從誠實的店主那裡偷東西的話。」");
	say();
labelFunc040B_0252:
