...
labelFunc04CA_00FB:
	...
	message("「大多數來到友誼會的人，都在與生命中的失敗搏鬥。他們本質上是在害怕自己。在冥想靜修處這裡，人們學習去相信自己。他們藉由學習如何將友誼會的哲學最好地應用在生活上，來建立那份信念。」");
	say();
	UI_remove_answer("聯繫");
labelFunc04CA_010E:
...
labelFunc04CA_01C7:
	...
	message("「唉，你剛好錯過他們了。我的好朋友 Elizabeth 和 Abraham 剛在這裡運送資金。我相信他們已經離開這裡去 Buccaneer's Den 了。」");
	say();
	gflags[0x0264] = true;
