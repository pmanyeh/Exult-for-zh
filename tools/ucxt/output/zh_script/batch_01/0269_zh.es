...
labelFunc0269_0009:
	...
	say();
	message("「當你完成這項任務時，將你的精力集中在 Buccaneer's Den 上。你或許會在那裡找到黑門位置的線索。");
	say();
...
labelFunc0269_0056:
	...
	say();
	message("「去 Buccaneer's Den 。尋找那個叫『Hook』的人。跟那些所謂的友誼會談談。你在那裡要查明他的下落應該不難。我相信你最終一定能找到黑門的位置！祝你好運！」*");
	say();
	gflags[0x0013] = true;
	Func0911(0x00C8);
	abort;
