...
labelFunc041A_02B4:
	...
	message("「友誼會推廣『樂觀認知（sanguine cognition）』的哲學，這是一種透過所謂的『內在力量三原則（Triad of Inner Strength）』，將積極的思維秩序應用於個人生活的方式。」");
	say();
...
labelFunc041A_02EE:
	...
	message("「對於那些出於某種原因覺得自己仍然需要它們的人來說，它們非常合適。但沒有人，甚至連你自己，聖者，你也必須承認，沒有人能完美地實踐它們。因此，它們最終是一種建立在失敗之上的哲學。我們從未聲稱我們的教義可以替代美德。然而，我們的信仰是建立在成功而非失敗之上的。」");
	say();
	UI_remove_answer("美德");
labelFunc041A_0301:
...
labelFunc041A_066F:
	...
	message("「那是一個遠離日常生活壓力和干擾的靜修之處，友誼會的新成員可以去那裡學習友誼會的哲學。它位於 Serpent's Hold 東方的一個島上。」");
	say();
