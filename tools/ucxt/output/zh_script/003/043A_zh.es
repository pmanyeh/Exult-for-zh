...
labelFunc043A_014B:
	...
	message("「我最近剛漆了我的餐車。它獲得了更多關注。現在生意好多了。我正在存錢要去海盜穴 (Buccaneer's Den) 旅行。」");
	say();
	UI_remove_answer("餐車");
	UI_add_answer(["生意", "海盜穴"]);
labelFunc043A_016B:
...
labelFunc043A_01E6:
	...
	say();
	UI_add_answer(["海盜勝地", "遊戲屋"]);
	UI_remove_answer("海盜穴");
labelFunc043A_0206:
	case "海盜勝地" attend labelFunc043A_0219:
	message("「我相信你也知道，海盜穴曾是小偷和惡棍的巢穴。因此，對於那些渴望體驗這種冒險生活的人來說，它有一種浪漫的吸引力。我承認，我就是其中之一。當你一生都在餐車賣魚時，你會需要一些刺激。海盜們最終意識到他們在暗地裡是多麼受人羨慕，所以他們把他們的島嶼變成了一個充滿刺激娛樂的地方。」");
	say();
	UI_remove_answer("海盜勝地");
labelFunc043A_0219:
	case "遊戲屋" attend labelFunc043A_022C:
	message("「據說他們那裡有幾種賭博遊戲！可以透過下注賽馬的結果來贏得金幣。」");
	say();
	UI_remove_answer("遊戲屋");
labelFunc043A_022C:
