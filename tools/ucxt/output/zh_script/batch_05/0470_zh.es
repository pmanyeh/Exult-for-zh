...
labelFunc0470_0157:
	...
	message("「現在沒有。但在我把這裡當成家之前，我是一名水手，一個……私掠者，來自 Buccaneer's Den。」");
	say();
	UI_add_answer(["你的家", "Buccaneer's Den"]);
labelFunc0470_0170:
...
labelFunc0470_0191:
	...
	message("「你聽過 Buccaneer's Den，不是嗎？就在大陸正東方的那座島。那裡住著一些裝木腿、手是鐵鉤、肩膀上還停著鸚鵡的男人！哈！哈！」");
	say();
...
labelFunc0470_01B1:
	...
	message("「對，我認識 Hook 。你在找他嗎？他來自 Buccaneer's Den。他通常跟一個叫 Forskis 什麼的石像鬼一起行動。如果你見到他，替我向他……『問好』。」他揮了揮緊握的拳頭。");
	say();
