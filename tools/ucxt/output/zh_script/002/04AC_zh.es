...
labelFunc04AC_01A7:
	...
	message("「我不時會保留少量銀蛇毒液庫存，賣給 Britannia 的藥劑師以賺取微薄利潤。政府正試圖控制它的銷售，直到他們能夠確定它的影響有多危險。」");
	say();
	UI_remove_answer("供應");
...
labelFunc04AC_04F8:
	...
	message("「我的貨源來自 Buccaneer's Den 的一些老朋友。他們從哪裡弄來的，誰知道呢？」");
	say();
	UI_remove_answer("販賣");
labelFunc04AC_050B:
...
labelFunc04AC_0525:
	...
	message("「這是眾所周知的。銀蛇毒液是一種試劑，當少量攝入時，會暫時增強體力、耐力和敏捷度，並帶來欣快感。~~『當效果消退後，服用者會感到非常疲憊。這往往會讓他們想要再次服用。~~『以這種方式長期使用會導致皮膚惡化，最終腐爛。~~『最後，過大的劑量或累積過多劑量是致命的，因為毒液是一種致命的毒藥。~~『當以我們尚未發現的其他方式使用時，它很可能具有一些治癒的特性，但任何毒液的使用者都不應該不加謹慎地使用它。』」");
	say();
	UI_remove_answer("影響");
	UI_add_answer("使用者");
labelFunc04AC_053F:
