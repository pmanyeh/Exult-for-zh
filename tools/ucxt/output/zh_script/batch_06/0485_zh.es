...
labelFunc0485_0266:
	...
	message("「他是個有錢人，他的兩個朋友是高大強壯的男人。他們一直跟我說一個聽起來很棒的地方，叫 Buccaneer's Den 。」");
	say();
	UI_remove_answer("Robin");
	UI_add_answer(["朋友", "Buccaneer's Den"]);
labelFunc0485_0286:
...
labelFunc0485_02A6:
	...
	message("「Buccaneer's Den 一定是個仙境。那裡有一個會給你錢的紡車！你能想像嗎！還有富麗堂皇、奢華的浴池。」");
	say();
