...
labelFunc0487_00A7:
	...
	message("「Robin 是個玩大賭注的賭客，他在 Buccaneer's Den 的賭場裡討生活。」");
	say();
...
labelFunc0487_0132:
	...
	message("「Buccaneer's Den 的賭場叫做遊戲廳(House of Games)，那是我這輩子見過最棒的地方。我永遠不會忘記 Robin 第一次帶我去那裡的情景。他不到一個小時就帶著一百枚金幣離開了！」");
	say();
	UI_remove_answer("賭場");
labelFunc0487_0145:
...
labelFunc0487_01F6:
	...
	message("「我們正想離開這塊無聊的破石頭，New Magincia，回到 Buccaneer's Den 去。如果你有辦法帶我們去那裡，遠離這些鄉巴佬，Robin 少爺會付你豐厚的報酬的。」");
	say();
