...
labelFunc0486_00FF:
	...
	message("「我不是本地人。在與賭場老闆發生爭執後，我和我的同僚們不得不迅速離開 Buccaneer's Den。那也是一段艱辛的航程。」");
	say();
	UI_add_answer(["同僚", "Buccaneer's Den", "爭執", "航程"]);
...
labelFunc0486_020C:
	...
	message("「我們正試圖回到 Buccaneer's Den。我本來希望能賣掉我手邊的一個金吊飾盒來買我們回去的船票，但我恐怕它已經遺失了。如果你有遇到它，一定要讓我知道。」");
	say();
	UI_remove_answer("吊飾盒");
labelFunc0486_021F:
	case "友誼會" attend labelFunc0486_0249:
	message("「你是友誼會的成員！多年來，我一直看到友誼會的成員在遊戲廳(House of Games)贏得大筆賭金。你能告訴我他們的祕密嗎？」");
	say();
	var0006 = Func090A();
...
labelFunc0486_0249:
	...
	message("「如果你願意載我們回 Buccaneer's Den，我可以付給你豐厚的報酬。」");
	say();
	UI_add_answer("報酬");
...
labelFunc0486_027E:
	...
	message("「當然，我現在此時此刻無法付錢給你。但當我們到達 Buccaneer's Den 時，我向你保證，我能拿到很多錢。」");
	say();
	UI_remove_answer("報酬");
	UI_add_answer("很多錢");
labelFunc0486_0298:
	case "很多錢" attend labelFunc0486_02B2:
	message("「是的，錢！因為我在 New Magincia 這裡找到了一樣東西，在 Buccaneer's Den 它的價值將超過黃金。」");
	say();
...
labelFunc0486_0309:
	...
	message("「既然我知道我可以信任你，我就可以讓你知道我們的計畫。我打算用你的船多帶一個乘客跟我們一起回 Buccaneer's Den。她的名字是 Constance，她應該能從浴池經營者 Glenno 那裡賣個好價錢。足以償還我的債務、付你船資，還有很多剩餘的錢可以讓我在遊戲廳再賭一把！」");
	say();
	Func0911(0x0064);
	gflags[0x0184] = true;
	UI_add_answer("船");
