...
labelFunc0488_0167:
	...
	message("「他是一名職業賭徒，在 Buccaneer's Den 的遊戲廳賭桌上贏錢。」");
	say();
	...
	UI_show_npc_face(0xFF78, 0x0000);
labelFunc0488_0198:
	UI_add_answer(["職業", "Buccaneer's Den"]);
...
labelFunc0488_021B:
	...
	message("「當 Robin 少爺無法償還債務時，『先生』派了他的打手 Sintag 和他的無賴們來追捕我們。我們不得不搭乘第一艘離開 Buccaneer's Den 的船。我不知道他為什麼被稱為『先生』。」");
	say();
...
labelFunc0488_02AA:
	...
	message("「如果你有辦法讓我們回到 Buccaneer's Den，Robin 少爺會豐厚地獎賞你。」");
	say();
	UI_remove_answer("受困");
labelFunc0488_02BD:
