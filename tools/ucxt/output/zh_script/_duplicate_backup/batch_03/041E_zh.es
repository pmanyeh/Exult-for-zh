...
labelFunc041E_006F:
	...
	message("「我是皇家劇院的女演員。我在新戲裡扮演老鼠 Sherry 的角色。」");
	say();
	UI_add_answer(["皇家劇院", "Sherry", "戲劇"]);
labelFunc041E_008B:
	case "皇家劇院" attend labelFunc041E_00AB:
	message("「那是個很棒的表演空間。我已經將我的一生奉獻給演戲了，你知道的。」");
	say();
	UI_remove_answer("皇家劇院");
	UI_add_answer(["空間", "奉獻"]);
labelFunc041E_00AB:
	case "空間" attend labelFunc041E_00BE:
	message("「Raymundo 本人參與了劇院的設計。」");
	say();
	UI_remove_answer("空間");
labelFunc041E_00BE:
	case "奉獻" attend labelFunc041E_00D1:
	message("「實際上，這將是我第一次的戲劇演出。我一直在當酒吧女侍，等待我在劇院的第一個機會。」");
	say();
	UI_remove_answer("奉獻");
labelFunc041E_00D1:
	case "戲劇" attend labelFunc041E_00E4:
	message("「你知我知就好，我覺得這齣戲爛透了。」她對你眨了眨眼。");
	say();
	UI_remove_answer("戲劇");
labelFunc041E_00E4:
	case "Sherry" attend labelFunc041E_0104:
	message("「你能想像這種廢話嗎？我不相信真的有老鼠 Sherry 。誰聽過會說話的老鼠！尤其是這些台詞！我寧願演女王。我會說，那對我來說合適多了。」");
	say();
...
labelFunc041E_0117:
	...
	message("「我問了 Raymundo 這件事，他就發脾氣了。他說那樣不符合歷史。哈！說得好像那很重要一樣！」");
	say();
	UI_remove_answer("女王");
labelFunc041E_012A:
	...
	message("「大便頭 (Poo Poo Head) ！」她大叫。然後她衝向他，重重地吻了他的嘴。 Shamino 臉紅了，不安地挪動著腳步。*");
	say();
	UI_show_npc_face(0xFFFD, 0x0000);
	message("「不要在聖者面前這樣，Poo！」*");
	say();
	UI_remove_npc_face(0xFFFD);
	UI_show_npc_face(0xFFE2, 0x0000);
	message("「管他什麼聖者！」她又吻了他。「聖者是最不可能說服你安定下來的人。」");
	say();
	goto labelFunc041E_016F;
labelFunc041E_016B:
	message("「你認識我的男朋友嗎？他大概在藍野豬酒館裡借酒澆愁。這個懶惰的無賴！我不會讓他去冒險的。他該安定下來了。你可以告訴他這是我說的！」");
	say();
labelFunc041E_016F:
	gflags[0x006D] = true;
	gflags[0x006E] = true;
