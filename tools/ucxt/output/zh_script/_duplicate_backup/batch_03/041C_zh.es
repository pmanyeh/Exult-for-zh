...
labelFunc041C_002C:
	...
	message("這是一個又高又瘦、膝蓋骨突出的男演員。");
	say();
	if (!var0000) goto labelFunc041C_0051;
	message("他戴著女人的假髮，男扮女裝。");
	say();
labelFunc041C_0051:
	gflags[0x009D] = true;
...
labelFunc041C_0077:
	...
	say();
labelFunc041C_008C:
	message("「我是 Jesse ，我是一個明星。」");
	say();
	UI_remove_answer("姓名");
	if (!var0000) goto labelFunc041C_00A1;
	message("他打了自己一巴掌，然後用正常的聲音說：「哎呀，抱歉！我太入戲了，有時會忘記我不是個女人！」");
	say();
labelFunc041C_00A1:
	case "職業" attend labelFunc041C_00BA:
	message("「我在皇家劇院當演員。在我的職業生涯中，我演過『所有』偉大的角色。我現在有機會扮演一生難求的角色——聖者！」");
	say();
	UI_add_answer(["皇家劇院", "聖者"]);
labelFunc041C_00BA:
	case "皇家劇院" attend labelFunc041C_00DA:
	message("「因為它必須迎合大眾，所以我們從來沒有機會做實驗性的作品——只有傳統平庸的雜碎。但這是一個很棒的空間，而且音響效果極佳。」");
	say();
	UI_add_answer(["大眾", "實驗性作品"]);
	UI_remove_answer("皇家劇院");
labelFunc041C_00DA:
	case "大眾" attend labelFunc041C_00ED:
	message("「人們喜歡看英雄冒險的故事、穿著盔甲的騎士、美麗的公主、明智的國王、巫師、邪惡的怪物。所有這些爛東西。」");
	say();
	UI_remove_answer("大眾");
labelFunc041C_00ED:
	case "聖者" attend labelFunc041C_010D:
	message("「這個角色非常具挑戰性。我有大量的台詞，而且我必須和教練一起訓練好幾個星期，為所需的大量活動做準備。這個角色會讓『Jesse』這個名字家喻戶曉！」");
	say();
	UI_add_answer(["具挑戰性", "台詞"]);
	UI_remove_answer("聖者");
labelFunc041C_010D:
	case "具挑戰性" attend labelFunc041C_0120:
	message("「這絕對是有史以來構思最宏大的戲劇作品。有超過一百個小時的演出時間。對觀眾來說，這是一段很長的時間。」");
	say();
	UI_remove_answer("具挑戰性");
labelFunc041C_0120:
	case "台詞" attend labelFunc041C_0133:
	message("「我最大的台詞是：~~「姓名！」~~「職業！」~~「告辭！」」");
	say();
	UI_remove_answer("台詞");
labelFunc041C_0133:
	case "實驗性作品" attend labelFunc041C_0146:
	message("「我最喜歡的作品是 Raymundo 為我寫的，名為《三人共穿一件護襠》。我站在舞台上，邀請觀眾加入我，把一件內衣撕成碎片，然後把它們放進骨灰甕裡，與小麥糊混合。是碎布，不是觀眾。然後觀眾可以把碎片黏在我身上他們想要的任何地方。」");
	say();
