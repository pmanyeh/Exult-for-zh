...
void Func0870 0x870 (var var0000, var var0001, var var0002)
{
	...
	message("「我有資格提供治療 (heal)、解毒 (cure poison) 和復活 (resurrect) 服務。你對這些服務有興趣嗎？」");
	say();
	UI_push_answers();
	var0003 = Func090A();
...
labelFunc0870_008F:
	...
	if (!(var000A == 0x0000)) goto labelFunc0870_00D9;
	message("「我沒看到任何人需要復活。我必須看到屍體才能復活。如果你帶著你朋友的遺體，請將他們放在地上，以便我能照料他們。」");
	say();
	abort;
labelFunc0870_00D9:
	message("「你的朋友受了重傷。我會試著恢復他們。」");
	say();
	var0007 = var0002;
labelFunc0870_00E3:
	message("「我的價格是 ");
...
labelFunc0870_015B:
	message("「嘖嘖。你沒有足夠的金幣支付這項服務。我希望改天能幫上你的忙。」");
	say();
labelFunc0870_015F:
