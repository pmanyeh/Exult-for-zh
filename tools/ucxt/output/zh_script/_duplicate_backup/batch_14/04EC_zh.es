...
labelFunc04EC_0041:
	...
	message("這是一個看起來很和藹且熱情的女人。「我很榮幸能見到聖者 (Avatar) ，」她笑容滿面地說。");
	say();
	gflags[0x0050] = true;
	goto labelFunc04EC_0057;
labelFunc04EC_0053:
	message("「是的，聖者 (Avatar) ？」 Ellen 問。");
	say();
labelFunc04EC_0057:
	UI_add_answer(["姓名", "職業", "murder", "告辭"]);
labelFunc04EC_006A:
