...
void Func0879 0x879 (var var0000, var var0001, var var0002)
{
	...
	if (!((var0005 == "治療") || (var0005 == "解毒"))) goto labelFunc0879_008F;
	if (!(var0005 == "治療")) goto labelFunc0879_0058;
	var0006 = "被治療";
	var0007 = var0000;
labelFunc0879_0058:
	if (!(var0005 == "解毒")) goto labelFunc0879_006E;
	var0006 = "被解毒";
	var0007 = var0001;
labelFunc0879_006E:
	message("「你希望誰");
	...
	message("「雖然我想做你的生意，但我很高興看到不需要我的服務！」");
	say();
	goto labelFunc0879_016B;
labelFunc0879_008F:
	if (!(var0005 == "復活")) goto labelFunc0879_00E1;
...
labelFunc0879_00CA:
	...
	message("「好吧，我似乎沒看到有誰需要我的幫助。除非你在背包裡裝著某個人……」他笑了起來。*");
	say();
	goto labelFunc0879_016B;
labelFunc0879_00DB:
	var0007 = var0002;
labelFunc0879_00E1:
	...
	if (!(var0005 == "治療")) goto labelFunc0879_012A;
	Func091D(var0008, var0007);
	goto labelFunc0879_0156;
labelFunc0879_012A:
	if (!(var0005 == "解毒")) goto labelFunc0879_0140;
	Func091E(var0008, var0007);
	goto labelFunc0879_0156;
labelFunc0879_0140:
	if (!(var0005 == "復活")) goto labelFunc0879_0156;
	Func091F(var000A, var0007);
	goto labelFunc0879_0156;
labelFunc0879_0156:
	goto labelFunc0879_015D;
labelFunc0879_0159:
	message("「你沒有那麼多金幣！也許你可以帶著更多金幣回來購買這項服務。」");
	say();
labelFunc0879_015D:
...
labelFunc0879_0164:
	goto labelFunc0879_016B;
labelFunc0879_0167:
	message("「很好。如果你以後需要我的服務，我隨時樂意為你效勞。」");
	say();
labelFunc0879_016B:
	UI_pop_answers();
	return;
