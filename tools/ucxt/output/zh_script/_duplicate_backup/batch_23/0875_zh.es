...
labelFunc0875_0032:
	...
	message("「我很抱歉，但你目前沒有足夠的實戰經驗來接受訓練。如果你能在日後回來，我會非常樂意訓練你。」");
	say();
	goto labelFunc0875_01BA;
labelFunc0875_005B:
	...
	message("「我很遺憾，你似乎沒有足夠的金幣在這裡訓練。或許等下一次，當你的財富更充裕時……」");
	say();
	goto labelFunc0875_01BA;
labelFunc0875_0093:
	if (!(var0006 == 0x0002)) goto labelFunc0875_00A4;
	message("「你已經和我一樣精通了！恐怕在這方面我無法再對你進行更多的訓練。」");
	say();
	goto labelFunc0875_01BA;
labelFunc0875_00A4:
...
labelFunc0875_010B:
	message("Denby 遞給");
	message(var0003);
	message("一張印有盧恩符文的圖表。「研究這些符文並記住它們，」他說。在");
	message(var0003);
	message("");
	message(var0009);
	message("這項任務之後，");
	...
	message("到在");
	message(var000B);
	message("腦海中多了一些以前沒有的知識。~~「現在我們來練習。每天至少練習兩次我教你的東西。這樣你就會變得更加敏捷和靈活。」^");
	message(var0003);
	message("");
	message(var000C);
	message("了一段時間模仿 Denby 展示給");
	message(var000D);
	message("的動作。最後，Denby 教了");
	message(var000D);
	message("幾個用於冥想的魔法詞語。當訓練課程完成時，");
	message(var0003);
	message("");
	message(var000A);
	message("充滿了活力，準備好迎接可能降臨到");
	message(var000B);
	message("面前的任何事情……*");
	say();
