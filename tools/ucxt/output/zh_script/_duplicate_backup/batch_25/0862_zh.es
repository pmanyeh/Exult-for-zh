...
void Func0862 0x862 ()
{
	...
	say();
	UI_clear_answers();
	var0005 = Func090B(["哈囉，Chuckles", "哈囉，傻瓜", "嗨，Chuckles", "嗨，Chuck"]);
...
labelFunc0862_0052:
	...
	var0005 = Func090B(["麻煩", "太多了", "很多問題", "我需要答案"]);
	if (!(var0005 == "太多了")) goto labelFunc0862_0088;
	message("「啊，我知道你的意思！你需要幫忙，對吧？」");
	say();
	var0002 = true;
	UI_clear_answers();
...
labelFunc0862_00F1:
	...
	var0005 = Func090B(["那真是太慷慨了", "我立刻需要它", "那是值得的", "我希望你會"]);
	if (!((var0005 == "那真是太慷慨了") || (var0005 == "我希望你會"))) goto labelFunc0862_012F;
	message("「你會給我什麼來換取線索？」");
	say();
	var0004 = true;
	UI_clear_answers();
...
labelFunc0862_0132:
	...
	var0005 = Func090B(["我不會殺了你", "金幣", "我的友誼", "一個微笑", "什麼都沒有"]);
	if (!(var0005 == "金幣")) goto labelFunc0862_0195;
	message("Chuckles 舉起手。「這不對。我免費給你一個線索。就在這個卷軸裡。」");
	say();
	...
	Func0911(0x0032);
	UI_clear_answers();
	message("「再見了，我的朋友！不要忘……我是說，不要忘記如何玩這個遊戲！」*");
	say();
	abort;
	goto labelFunc0862_0195;
labelFunc0862_0190:
	message("「喔！你沒有空間放這個卷軸了！放下你的東西，我就會把它給你！」*");
	say();
	abort;
labelFunc0862_0195:
...
labelFunc0862_01D3:
	message("「喔！你沒有空間放這個卷軸了！放下一些你的東西，我就能把它給你！」*");
	say();
	abort;
labelFunc0862_01D8:
	if (!((var0005 == "我不會殺了你") || ((var0005 == "我的友誼") || (var0005 == "什麼都沒有")))) goto labelFunc0862_01F5;
	Func0861();
labelFunc0862_01F5:
	return;
}
