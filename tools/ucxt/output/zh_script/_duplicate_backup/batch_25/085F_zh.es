...
labelFunc085F_0053:
	...
	message("「看來你需要更多時間來磨練你的反應神經。如果你希望晚點再來，當你有更多經驗時，我會很高興訓練你。」");
	say();
	goto labelFunc085F_0166;
labelFunc085F_007C:
	...
	message("「你沒有足夠的金幣付給我。我很抱歉，但我現在不能訓練你。」");
	say();
	goto labelFunc085F_0166;
labelFunc085F_00B4:
	if (!(var0009 == 0x0002)) goto labelFunc085F_00CB;
	message("「天啊！你太快了。事實上，你快到我無法幫你變得更快。我很抱歉，");
	message(var0005);
	message("。」");
	say();
	goto labelFunc085F_0166;
...
labelFunc085F_011B:
	message(var000C);
	message("和 Chad 對打了幾分鐘。他教");
	message(var000D);
	message("幾個在戰鬥中能更好地利用速度和敏捷性的專家級動作。");
	say();
