...
labelFunc0860_0074:
	...
	message("「所以你很健康？這真是好消息。如果你未來需要我的服務，請隨時回來。」");
	say();
...
labelFunc0860_0095:
	...
	message("「我道歉，");
	message(var0003);
	message("，但我沒看到有任何人需要復活。我必須能看到身體才能拯救靈魂。如果你帶著你不幸的朋友，請把他們放在地上，這樣我才能讓他們重返這個世界。」");
	say();
	abort;
labelFunc0860_00E5:
	message("「的確，你的朋友已經離開了這個世界。我會試著讓他們重返這個世界。」");
	say();
	var0008 = var0002;
labelFunc0860_00EF:
	message("「我的價格是 ");
...
labelFunc0860_0167:
	message("「你沒有任何金幣。我真的很抱歉。在你提供適當的費用之前我無法幫你。」Chantu 恭敬地鞠躬。");
	say();
labelFunc0860_016B:
	goto labelFunc0860_0172;
labelFunc0860_016E:
	message("「那我真的很抱歉。我必須收取我該收的費用。我們並非生活在繁榮的時代。」");
	say();
labelFunc0860_0172:
	goto labelFunc0860_0179;
labelFunc0860_0175:
	message("「好吧，如果你決定需要我的服務，我一直都在這裡。」");
	say();
labelFunc0860_0179:
	UI_pop_answers();
	return;
