...
labelFunc04E6_0085:
	...
	message("你簽了你的名字。「很好，");
	message(var0003);
	message("。歡迎來到遊戲之屋 (House of Games) ！」 Gordy 張開雙臂做了一個誇張的姿勢，顯然很高興能歡迎你的錢來到他的賭場。");
	say();
labelFunc04E6_00E3:
...
labelFunc04E6_011E:
	...
	say();
labelFunc04E6_0128:
	UI_add_answer(["老闆 (The Mister)", "遊戲之屋 (House of Games)", "技巧"]);
labelFunc04E6_0138:
	case "遊戲之屋 (House of Games)" attend labelFunc04E6_0158:
	message("「遊戲之屋 (House of Games) 是六年前用……一位利益相關者的資金建立的。它吸引了來自全 Britannia 想要用他們的錢過危險生活的人。這門生意非常有利可圖。」他拍了拍他的袋子，發出金幣叮噹的聲音。「非常有利可圖。」他笑著說。");
	say();
	UI_remove_answer("遊戲之屋 (House of Games)");
...
labelFunc04E6_01B0:
	...
	message("「嗯， Buccaneer's Den 不在 Britannia 稅務委員會的管轄範圍內。我們不受 Britannia 的稅收約束。」 Gordy 邪惡地笑著。「而那……非常有利可圖！」");
	say();
...
labelFunc04E6_01C3:
	...
	message("方塊震動了一會兒。「是的，我非常了解 Hook 。他住在遊戲之屋 (House of Games) 下面。去跟 Sintag 談談。他可以為你指路。」");
	say();
