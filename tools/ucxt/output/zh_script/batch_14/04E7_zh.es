...
labelFunc04E7_0351:
	...
	message("「他的家族在 Buccaneer's Den 已經好幾代了。如果你問我的話，我覺得他叫賣商品的方式有點太強勢了。」");
	say();
...
labelFunc04E7_03D6:
	...
	message("「他是另一個海盜。我知道他在遊戲之屋 (House of Games) 工作。我想他是負責實際遊戲的人。我跟他不熟。」");
	say();
	UI_remove_answer("Smithy");
labelFunc04E7_03E9:
	case "Sintag" attend labelFunc04E7_03FC:
	message("「布嚕嚕！他是個可怕的男人。你可以看出他殺過人。他是遊戲之屋 (House of Games) 的守衛。你絕對不會想被他抓到作弊！」");
	say();
